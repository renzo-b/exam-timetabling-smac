...
if __name__ == "__main__":
    ...
    configspace.add_hyperparameter(Categorical("mip_covers_switch", [-1,0,1,2,3], default=-1))
    configspace.add_hyperparameter(Float("number_of_cutting_plane_passes", [-1, 0], default=0))
    configspace.add_hyperparameter(Integer("cut_factor_row_multiplier_limit", [-1, 10], default=0)) #any postive float, 
